...
const TRANSLATIONS = {
    'id': {
        ...
        'paket-label-exclusive': 'Pilihan Investasi',
        'paket-title-exclusive': 'Struktur Paket & Pricing',
        'paket-subtitle-exclusive': 'Pilihan paket yang fleksibel dan transparan untuk mahasiswa, pelaku bisnis UMKM, hingga instansi premium.',
        ...
        'pricing-key-1': 'Template & Custom Build',
        'pricing-key-2': 'Keamanan Terjamin',
        'pricing-key-3': 'Infrastruktur Free-Tier / Cloud',
        'pricing-key-4': 'SLA Pengerjaan Jelas',
        'tier-starter-label': 'STARTER / EDU',
        'tier-starter-title': 'Paket Edu & Portofolio',
        'tier-starter-desc': 'Untuk mahasiswa, pelajar, atau portofolio pribadi. Fokus kecepatan & biaya termurah.',
        'tier-starter-f1': '✦ Berbasis Katalog Template ASYNC',
        'tier-starter-f2': '✦ Kustomisasi Visual Ringan (Warna, Logo, Teks)',
        'tier-starter-f3': '✦ Deploy Serverless Free-Tier (Vercel / Netlify)',
        'tier-starter-f4': '✦ Cloud Database Gratis (Supabase / Firebase)',
        'tier-starter-f5': '✦ Bebas Biaya Server & Hosting Bulanan',
        'tier-starter-f6': '✦ Estimasi: 1 - 2 Minggu',
        'tier-starter-note': '*Fitur & estimasi di atas bersifat fleksibel. Hubungi admin untuk kustomisasi khusus sesuai kebutuhan Anda.',
        'tier-umkm-badge': 'Rekomendasi Bisnis',
        'tier-umkm-label': 'UMKM / BISNIS DASAR',
        'tier-umkm-title': 'Paket Bisnis Dasar',
        'tier-umkm-desc': 'Untuk digitalisasi bisnis UMKM Anda dengan fitur inti (MVP) yang presisi & responsif.',
        'tier-umkm-f1': '✦ Menggunakan Desain Base-code Teruji',
        'tier-umkm-f2': '✦ Toko Online: Katalog & Order ke WhatsApp',
        'tier-umkm-f3': '✦ POS: Input Barang, Stok & Cetak Struk',
        'tier-umkm-f4': '✦ Integrasi Analytics Dasar (Google Analytics)',
        'tier-umkm-f5': '✦ Biaya Domain/Hosting Ditanggung Klien',
        'tier-umkm-f6': '✦ Estimasi: 2 - 4 Minggu',
        'tier-umkm-note': '*Kebutuhan modul & budget bersifat negotiable. Hubungi admin untuk merancang penawaran kustom bisnis Anda.',
        'tier-premium-label': 'PREMIUM / INSTANSI',
        'tier-premium-title': 'Paket Premium & Instansi',
        'tier-premium-desc': 'Sistem kustom penuh untuk enterprise, instansi pemerintah (B2B/B2G), & aplikasi kompleks.',
        'tier-premium-f1': '✦ Pembangunan Kustom Penuh (Built from Scratch)',
        'tier-premium-f2': '✦ Security: Hashing Data & Enkripsi AES-256',
        'tier-premium-f3': '✦ Dashboard Manajemen Data & Laporan (RBAC)',
        'tier-premium-f4': '✦ Integrasi Multi-API & Payment Gateway',
        'tier-premium-f5': '✦ Sistem ERP, SIAKAD, Klinik, & Layanan Desa',
        'tier-premium-f6': '✦ Garansi Pemeliharaan Pasca Rilis & SLA Support',
        'tier-premium-note': '*Spesifikasi, integrasi, & budget sepenuhnya dapat disesuaikan. Hubungi admin untuk menyusun proposal eksklusif.',
        // Details Cards
        'pricing-terms-title': 'Ketentuan Kemitraan',
        'pricing-terms-1': '<strong>Pembayaran Bertahap</strong> — Skema pembayaran termin (DP + Pelunasan Handover) yang fleksibel.',
        'pricing-terms-2': '<strong>Garansi & Support</strong> — Jaminan perbaikan bug/error pasca serah terima sistem.',
        'pricing-terms-3': '<strong>Dokumentasi Lengkap</strong> — Buku panduan/manual guide pengoperasian sistem.',
        'pricing-terms-4': '<strong>Hak Milik Penuh</strong> — Source code dan aset sepenuhnya menjadi milik klien.',
        'pricing-sla-title': 'Estimasi Pengerjaan & SLA',
        'pricing-infra-title': 'Standar Infrastruktur',
        'pricing-infra-1': '<strong>UI/UX Bersih & Presisi</strong> — Desain estetik dan modern nyaman di mobile & desktop.',
        'pricing-infra-2': '<strong>Infrastruktur Fleksibel</strong> — Hosting & Database Free-Tier (Rp 0) untuk Starter, atau Dedicated Server & Relational Database (MySQL/PostgreSQL) untuk UMKM & Premium.',
        'pricing-infra-3': '<strong>Teknologi Modern</strong> — Menggunakan React/Next.js, Supabase, Firebase, & Vercel.',
        'pricing-infra-4': '<strong>Keamanan Terkini</strong> — Enkripsi data sensitif (AES-256) untuk paket premium/instansi.',
        // Footer
    ...
    'en': {
        ...
        'paket-label-exclusive': 'Investment Choices',
        'paket-title-exclusive': 'Package Structure & Pricing',
        'paket-subtitle-exclusive': 'Flexible and transparent package options for students, MSMEs, and premium institutions.',
        'projects-label': 'Portfolio',
        ...
        'pricing-key-1': 'Template & Custom Build',
        'pricing-key-2': 'Guaranteed Security',
        'pricing-key-3': 'Free-Tier / Cloud Infrastructure',
        'pricing-key-4': 'Clear Timeline SLA',
        'tier-starter-label': 'STARTER / EDU',
        'tier-starter-title': 'Edu & Portfolio Package',
        'tier-starter-desc': 'For students or personal portfolios. Focus on speed & lowest cost.',
        'tier-starter-f1': '✦ ASYNC Template Catalog-Based',
        'tier-starter-f2': '✦ Lightweight Visual Customization (Color, Logo, Text)',
        'tier-starter-f3': '✦ Deploy to Serverless Free-Tier (Vercel / Netlify)',
        'tier-starter-f4': '✦ Free Cloud Database (Supabase / Firebase)',
        'tier-starter-f5': '✦ Free Monthly Server & Hosting Costs',
        'tier-starter-f6': '✦ Estimate: 1 - 2 Weeks',
        'tier-starter-note': '*Features & estimates above are flexible. Contact admin for customization options based on your needs.',
        'tier-umkm-badge': 'Business Choice',
        'tier-umkm-label': 'UMKM / BASIC BUSINESS',
        'tier-umkm-title': 'Basic Business Package',
        'tier-umkm-desc': 'To digitalize your MSME business with precise & responsive core features (MVP).',
        'tier-umkm-f1': '✦ Uses Proven Base-code Design',
        'tier-umkm-f2': '✦ E-commerce: Catalog & WhatsApp Ordering',
        'tier-umkm-f3': '✦ POS: Goods Input, Stock & Receipt Printing',
        'tier-umkm-f4': '✦ Basic Google Analytics Integration',
        'tier-umkm-f5': '✦ Domain & Hosting Cost Covered by Client',
        'tier-umkm-f6': '✦ Estimate: 2 - 4 Weeks',
        'tier-umkm-note': '*Module requirements & budget are negotiable. Contact admin to design a custom offer for your business.',
        'tier-premium-label': 'PREMIUM / INSTITUTION',
        'tier-premium-title': 'Premium & Institution Package',
        'tier-premium-desc': 'Fully custom systems for enterprises, government agencies (B2B/B2G), & complex apps.',
        'tier-premium-f1': '✦ Fully Custom Build (Built from Scratch)',
        'tier-premium-f2': '✦ Security: Data Hashing & AES-256 Encryption',
        'tier-premium-f3': '✦ Data Management Dashboard & Reports (RBAC)',
        'tier-premium-f4': '✦ Multi-API & Payment Gateway Integrations',
        'tier-premium-f5': '✦ ERP, SIAKAD, Clinic, & Village Systems',
        'tier-premium-f6': '✦ Post-Release Maintenance Warranty & SLA Support',
        'tier-premium-note': '*Specifications, integrations, & budget are fully customizable. Contact admin to draft an exclusive proposal.',
        // Details Cards
        'pricing-terms-title': 'Partnership Terms',
        'pricing-terms-1': '<strong>Milestone Payment</strong> — Flexible milestone-based payments (DP + Handover).',
        'pricing-terms-2': '<strong>Warranty & Support</strong> — Bug/error fixes warranty post-system handover.',
        'pricing-terms-3': '<strong>Complete Docs</strong> — Manual guide book for system operations.',
        'pricing-terms-4': '<strong>Full Ownership</strong> — Source code and assets are fully owned by the client.',
        'pricing-sla-title': 'Project Estimates & SLA',
        'pricing-infra-title': 'Infrastructure Standards',
        'pricing-infra-1': '<strong>Clean & Precise UI/UX</strong> — Aesthetic and modern design responsive on mobile & desktop.',
        'pricing-infra-2': '<strong>Flexible Infrastructure</strong> — Free-Tier Hosting & Database (Rp 0) for Starter, or Dedicated Server & Relational Database (MySQL/PostgreSQL) for UMKM & Premium.',
        'pricing-infra-3': '<strong>Modern Stack</strong> — Built using React/Next.js, Supabase, Firebase, & Vercel.',
        'pricing-infra-4': '<strong>State-of-the-art Security</strong> — Sensitive data encryption (AES-256) for premium/institution tier.',
        // Footer
