...
function disableCmsMode() {
   ...
   Language Toggle
            ...
            function initLanguageToggle() {
                ...
                function updateLangUI(lang) {
                    ...
                    if (lang === 'en') {
                        ...
                        // Revert to ID (or reload page if complex, but text swap is faster)
                        safeSetText('.hero-cta .btn-primary span:first-child', dict.hero.cta1);
                        safeSetText('.hero-cta .btn-ghost span', dict.hero.cta2);
                        safeSetText('.hero-eyebrow .editable', dict.hero.eyebrow);
                        safeSetText('.section-kenapa-bento .section-title', dict.sect.why);
            ...
            /* ============================================
               ...
               ============================================ */
            import { getDoc, setDoc } from "https://www.gstatic.com/firebasejs/11.0.2/firebase-firestore.js";
            ...
            async function loadCmsContent() {
                try {
                    ...
                    if (docSnap.exists()) {
                        ...
                        localStorage.setItem('aspyreCmsContent', JSON.stringify(data)); // Cache for offline/speed
                    } else {
            ...
            function applyCmsContent(data) {
                ...
                Object.keys(data).forEach(key => {
                    ...
                    if (el) el.innerHTML = data[key]; // Secure enough for internal tool
                });
            }
