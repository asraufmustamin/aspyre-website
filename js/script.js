...
const TRANSLATIONS = {
    'id': {
        ...
        'tier-starter-f1': '✦ Berbasis Template (Base-code Siap Pakai)',
        'tier-starter-f2': '✦ Custom Warna, Logo, & Konten',
        'tier-starter-f3': '✦ Deploy Vercel / Firebase (Free-tier)',
        'tier-starter-f4': '✦ Cloud DB Supabase / Firebase',
        'tier-starter-f5': '✦ Maintenance & Hosting Selamanya Rp 0',
        'tier-starter-f6': '✦ Estimasi: 3 Hari - 2 Minggu',
        ...
        'tier-umkm-f1': '✦ Fitur Inti Operasional Bisnis (MVP)',
        'tier-umkm-f2': '✦ Clean & Elegant visual template',
        'tier-umkm-f3': '✦ E-commerce: Catalog, Cart & WhatsApp Order',
        'tier-umkm-f4': '✦ POS: Stok In/Out & Print Struk Sederhana',
        'tier-umkm-f5': '✦ Integrasi Google Analytics Dasar',
        'tier-umkm-f6': '✦ Estimasi: 1 Minggu - 4 Minggu',
        ...
        'tier-premium-f1': '✦ Pembuatan Kustom Penuh (Custom Build dari Nol)',
        'tier-premium-f2': '✦ Security: Hashing Data & Enkripsi AES-256',
        'tier-premium-f3': '✦ Modul Analitik Berlapis & Dashboard (RBAC)',
        'tier-premium-f4': '✦ Integrasi API Gateway & Payment Gateway',
        'tier-premium-f5': '✦ Sistem ERP, SIAKAD, Klinik, & Layanan Desa',
        'tier-premium-f6': '✦ Garansi Pemeliharaan & Support SLA 24/7',
        // Details Cards
        ...
        'pricing-terms-3': '<strong>Dokumentasi Lengkap</strong> — Manual guide atau video tutorial pengoperasian sistem.',
        ...
        'pricing-infra-2': '<strong>Hosting Efisien</strong> — Cloud hosting free-tier (hosting Rp 0) untuk menekan biaya maintenance.',
    ...
    'en': {
        ...
        'tier-starter-f1': '✦ Template-Based (Ready-to-Use Base-code)',
        'tier-starter-f2': '✦ Custom Colors, Logo, & Content',
        'tier-starter-f3': '✦ Deploy via Vercel / Firebase (Free-tier)',
        'tier-starter-f4': '✦ Supabase / Firebase Cloud Database',
        'tier-starter-f5': '✦ Free Maintenance & Hosting (Rp 0/yr)',
        'tier-starter-f6': '✦ Estimate: 3 Days - 2 Weeks',
        ...
        'tier-umkm-f1': '✦ Core Business Operational Features (MVP)',
        'tier-umkm-f2': '✦ Clean & Elegant visual template',
        'tier-umkm-f3': '✦ E-commerce: Catalog, Cart & WhatsApp Order',
        'tier-umkm-f4': '✦ POS: Stock In/Out & Simple Receipt Print',
        'tier-umkm-f5': '✦ Basic Google Analytics Integration',
        'tier-umkm-f6': '✦ Estimate: 1 Week - 4 Weeks',
        ...
        'tier-premium-f3': '✦ Multi-layer Analytics & Dashboard (RBAC)',
        'tier-premium-f4': '✦ API Gateway & Payment Gateway Integrations',
        'tier-premium-f5': '✦ ERP, SIAKAD, Clinic, & Village Systems',
        'tier-premium-f6': '✦ Maintenance Warranty & 24/7 SLA Support',
        // Details Cards
        ...
        'pricing-terms-3': '<strong>Complete Docs</strong> — Manual guides or video tutorials for system operations.',
        ...
        'pricing-infra-2': '<strong>Efficient Hosting</strong> — Free-tier cloud hosting (Rp 0/yr) to eliminate maintenance costs.',
